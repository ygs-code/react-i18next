...
const WebpackPluginUpdateVersion = require('./definePlugin/webpack-plugin-update-version');
...
if (fs.existsSync(path.join(process.cwd(), './htmllinter.config.js'))) {
  htmllinterConfig = require(
    path.join(process.cwd(), './htmllinter.config.js'),
  );
}
...
module.exports = {
  ...
  plugins: [
    new WebpackPluginUpdateVersion(),
